import{j as e,M as o}from"./iframe-BNWelFxJ.js";import{useMDXComponents as r}from"./index-9xe-tnWN.js";import"./preload-helper-Dp1pzeXC.js";function i(s){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...r(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{title:"Foundation"}),`
...
`,e.jsxs(n.p,{children:["To generate a working output of the parsed tokens from Figma we are using the ",e.jsx(n.a,{href:"https://amzn.github.io/style-dictionary/#/",rel:"nofollow",children:"Style dictionary"})," package and the several so called transformers. These transformers supports us by transforming the design tokens into platform specific deliverables. Currently, we supporting following deliverables:"]}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"CSS variables"}),`
`,e.jsx(n.li,{children:"SCSS variables"}),`
`,e.jsx(n.li,{children:"JavaScript variables"}),`
`,e.jsx(n.li,{children:"React Native variables and stylesheet objects"}),`
`]}),`
`,e.jsx(n.p,{children:"All of these deliverables are generated per brand, in light and dark mode, and for the viewports mobile, tablet, and desktop."}),`
`,e.jsx(n.p,{children:"Furthermore, we are also bundling the following assets:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Fonts (sans and serif)"}),`
`]}),`
...
`,e.jsx(n.h2,{id:"consumption",children:"Consumption"}),`
...
`,e.jsxs(n.p,{children:["Hint: The ",e.jsx(n.code,{children:"main.css"})," and ",e.jsx(n.code,{children:"main.min.css"})," files are only available within the CSS deliverable."]}),`
`]}),`
`,e.jsx(n.h3,{id:"via-npm-registry",children:"Via NPM registry"}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-js",children:`pnpm add @kosmos/foundation
`})}),`
...
`})}),`
`,e.jsx(n.p,{children:"or for any specific deliverables like this:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-js",children:`import '@kosmos/foundation/js/BRAND/light-mode-mobile' ||
import '@kosmos/foundation/react-native/BRAND/light-mode-tablet' ||
import '@kosmos/foundation/scss/BRAND/light-mode-desktop'
`})})]})}function t(s={}){const{wrapper:n}={...r(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(i,{...s})}):i(s)}export{t as default};
